...
public class ElementLayer {
    ...
    public static void clickExpectedValue(List<WebElement> combinedList, String expectedString, ExtentTest extentedReport, WebDriver driver) throws Exception {
        System.out.println("Size of util is  "+combinedList.size());
        for (Iterator iterator = combinedList.iterator(); iterator.hasNext();) {
               WebElement webElement = (WebElement) iterator.next();
               System.out.println("*********\n");
               System.out.println("****************Name of web element is "+ webElement.getText());
               if (webElement.getText().equals(expectedString)) {
                     webElement.click();                      
                     //Log.message("Entered Location : " + expectedString, driver, extentedReport);
                     Thread.sleep(2000);
                     break;
               }                    
               System.out.println("*********\n");              
   ...
   /* public static void selectExpectedValue(List<Select> dropdownValues, String expectedString, ExtentTest extentedReport, WebDriver driver) throws Exception {
            System.out.println("Options of util is  "+dropdownValues.size());
            for (Iterator iterator = dropdownValues.iterator(); iterator.hasNext();) {
                   Select select = (Select) iterator.next();
                   System.out.println("*********\n");
                   System.out.println("****************Name of web element is "+ select.getOptions());
                   if (select.getOptions().equals(expectedString)) {
                        select.selectByVisibleText(expectedString);              
                         Log.message("Entered Location : " + expectedString, driver, extentedReport);
                         Thread.sleep(5000);
                         break;
                   }                    
